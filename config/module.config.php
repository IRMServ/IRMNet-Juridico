...
return array(
      'acl' => array(
        'Juridico' => array(
            'JURIDICO' => array(
                'Juridico\Controller\Index:index',              
            ),
            'TI' => array(
                'Juridico\Controller\Index:index',              
            ),
        ...
        'routes' => array(
            ...
            'juridico' => array(
                ...
                'options' => array(
                    'route' => '/juridico',
                    'defaults' => array(
                       // '__NAMESPACE__' => 'Juridico\Controller',
                        'controller' => 'Juridico\Controller\Index',
                        'action' => 'index',
                    ),
                ),
            ),
    ...
    'controllers' => array(
        'invokables' => array(
            'Juridico\Controller\Index' => 'Juridico\Controller\IndexController'
        ),
    ),
    'view_manager' => array(
